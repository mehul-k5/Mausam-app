...
import com.example.mausam.databinding.ActivityDetailBinding;
import com.example.mausam.utilities.MausamDateUtils;
import com.example.mausam.utilities.MausamWeatherUtils;

public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    private static final String FORECAST_SHARE_HASHTAG = " #MausamApp";
...
//      COMPLETED (25) Check before doing anything that the Cursor has valid data
        ...
        int weatherImageId = MausamWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
        ...
        String dateText = MausamDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);
...
//      COMPLETED (27) Display the weather description (using SunshineWeatherUtils)
         ...
         * Weather Description *
         ***********************/
        String description = MausamWeatherUtils.getStringForWeatherCondition(this, weatherId);
...
//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
         ...
         * String.
         */
        String highString = MausamWeatherUtils.formatTemperature(this, highInCelsius);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
         ...
         * String.
         */
        String lowString = MausamWeatherUtils.formatTemperature(this, lowInCelsius);
...
//      COMPLETED (19) Set the content description of the humidity label to the humidity a11y String
        ...
        String windString = MausamWeatherUtils.getFormattedWind(this, windSpeed, windDirection);
