...
import com.example.mausam.data.WeatherContract.WeatherEntry;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
     ...
     *
     * The reason DATABASE_VERSION starts at 3 is because Mausam has been used in conjunction
     * with the Android course for a while now. Believe it or not, older versions of Mausam
     * still exist out in the wild. If we started this DATABASE_VERSION off at 1, upgrading older
     * versions of Mausam could cause everything to break. Although that is certainly a rare
