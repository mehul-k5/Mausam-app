...
public class WeatherContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "com.example.mausam";

    /*
     * Use CONTENT_AUTHORITY to create the base of all URI's which apps will use to contact
     * the content provider for Mausam.
     */
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    /*
     * Possible paths that can be appended to BASE_CONTENT_URI to form valid URI's that Mausam
     ...
     *
     *      content://com.example.mausam/givemeroot/
     *
...
//       /* The base CONTENT_URI used to query the Weather table from the content provider */
        ...
        public static String getSqlSelectForTodayOnwards() {
            long normalizedUtcNow = MausamDateUtils.normalizeDate(System.currentTimeMillis());
