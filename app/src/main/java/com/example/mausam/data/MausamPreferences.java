...
public final class  MausamPreferences {
    ...
    /**
     * Returns true if the user prefers to see notifications from Mausam, false otherwise. This
    ...
    public static long getEllapsedTimeSinceLastNotification(Context context) {
        long lastNotificationTimeMillis =
                MausamPreferences.getLastNotificationTimeInMillis(context);
