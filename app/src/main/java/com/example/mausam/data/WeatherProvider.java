...
import com.example.mausam.utilities.MausamDateUtils;

/**
 * This class serves as the ContentProvider for all of Mausam's data. This class allows us to
...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In Mausam, we use CODE_WEATHER or CODE_WEATHER_WITH_DATE.
         */

        /* This URI is content://com.example.android.Mausam/weather/ */
        matcher.addURI(authority, WeatherContract.PATH_WEATHER, CODE_WEATHER);

        /*
         * This URI would look something like content://com.example.android.Mausam/weather/1472214172
    ...
    /**
     * Handles requests to insert a set of new rows. In Mausam, we are only going to be
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        ...
                        if (!MausamDateUtils.isDateNormalized(weatherDate)) {
    ...
    /**
     * Handles query requests from clients. We will use this method in Mausam to query for all
...
//      COMPLETED (10) Handle queries on both the weather and weather with date URI
        ...
        switch (sUriMatcher.match(uri)) {
             ...
             *
             *      content://com.example.Mausam/weather/1472214172
             *
             ...
             *
             *      content://com.example.Mausam/weather/
             *
             * sUriMatcher's match method will return the code that indicates to us that we need
...
//      COMPLETED (3) Return the number of rows deleted
    ...
    /**
     * In Mausam, we aren't going to do anything with this method. However, we are required to
     ...
     *
     * @param uri the URI to query.
     * @return nothing in Mausam, but normally a MIME type string, or null if there is no type.
     */
    @Override
    public String getType(@NonNull Uri uri) {
        throw new RuntimeException("We are not implementing getType in Mausam.");
    }
     ...
     * @return nothing in Mausam, but normally the URI for the newly inserted item.
     */
    @Override
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        throw new RuntimeException(
                "We are not implementing insert in Mausam. Use bulkInsert instead");
    }

    @Override
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        throw new RuntimeException("We are not implementing update in Mausam");
    }
