...
/**
 * Class for handling date conversions that are useful for Mausam.
 */
public final class MausamDateUtils {
     ...
     *
     * Normalize, in our usage within Mausam means to convert a given date in milliseconds to
