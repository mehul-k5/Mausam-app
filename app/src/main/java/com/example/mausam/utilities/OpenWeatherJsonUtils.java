...
public final class OpenWeatherJsonUtils {
    ...
    public static ContentValues[] getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
        ...
        MausamPreferences.setLocationDetails(context, cityLatitude, cityLongitude);
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        long normalizedUtcStartDay = MausamDateUtils.getNormalizedUtcDateForToday();
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
             ...
             */
            dateTimeMillis = normalizedUtcStartDay + MausamDateUtils.DAY_IN_MILLIS * i;
