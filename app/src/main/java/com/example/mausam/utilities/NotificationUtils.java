...
import com.example.mausam.DetailActivity;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        Uri todaysWeatherUri = WeatherContract.WeatherEntry
                .buildWeatherUriWithDate(MausamDateUtils.normalizeDate(System.currentTimeMillis()));
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            int largeArtResourceId = MausamWeatherUtils
            ...
            int smallArtResourceId = MausamWeatherUtils
             ...
             * we want to open Mausam to the DetailActivity to display the newly updated weather.
             */
             ...
             */
            MausamPreferences.saveLastNotificationTime(context, System.currentTimeMillis());
        }
    ...
    private static String getNotificationText(Context context, int weatherId, double high, double low) {
         ...
         */
        String shortDescription = MausamWeatherUtils
        ...
        String notificationText = String.format(notificationFormat,
                shortDescription,
                MausamWeatherUtils.formatTemperature(context, high),
                MausamWeatherUtils.formatTemperature(context, low));
