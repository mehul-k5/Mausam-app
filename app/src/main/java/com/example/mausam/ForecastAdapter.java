...
//          COMPLETED (15) If the view type of the layout is today, display a large icon
            case VIEW_TYPE_TODAY:
                weatherImageId = MausamWeatherUtils
...
//          COMPLETED (17) Otherwise, throw an IllegalArgumentException
        ...
        String dateString = MausamDateUtils.getFriendlyDateString(mContext, dateInMillis, false);
         ...
         * Weather Description *
         ***********************/
        String description = MausamWeatherUtils.getStringForWeatherCondition(mContext, weatherId);
         ...
         * String.
         */
        String highString = MausamWeatherUtils.formatTemperature(mContext, highInCelsius);
        /* Create the accessibility (a11y) String from the weather description */
         ...
         * String.
         */
        String lowString = MausamWeatherUtils.formatTemperature(mContext, lowInCelsius);
